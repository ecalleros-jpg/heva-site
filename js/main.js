...
const T = {
  es: {
    ...
    'pl-sm-spec':   'Bariatric & Plastics · Tijuana',
    'pl-sm-sub':    'SERVICIOS DISPONIBLES',
    'pl-sm-i1n':    'Manga Gástrica Premium',
    'pl-sm-i1c':    'Bariatric',
    'pl-sm-i2n':    'All-on-6 Sistema Completo',
    'pl-sm-i2c':    'Dentistry',
    'pl-sm-i3n':    'Paquete Recuperación · 3 noches',
    'pl-sm-i3c':    'Hospedaje incluido',
    'pl-sm-i4n':    'Traslado aeropuerto + clínica',
    'pl-sm-i4c':    'Transporte',
    'pl-sm-add':    'Agregar',
    ...
    'wa-h-h1':      'Tu práctica no se detiene.<br>Tu dinero tampoco.',
    'wa-h-sub':     'El primer banco digital para la medicina global. Recibe cada pago al instante, retén tu valor en dólares y retira cuando y como quieras. Sin esperas. Sin intermediarios.',
  ...
  en: {
    ...
    'pl-sm-spec':   'Bariatric & Plastics · Tijuana',
    'pl-sm-sub':    'AVAILABLE SERVICES',
    'pl-sm-i1n':    'Premium Gastric Sleeve',
    'pl-sm-i1c':    'Bariatric',
    'pl-sm-i2n':    'All-on-6 Full System',
    'pl-sm-i2c':    'Dentistry',
    'pl-sm-i3n':    'Recovery Package · 3 nights',
    'pl-sm-i3c':    'Lodging included',
    'pl-sm-i4n':    'Airport + clinic transfer',
    'pl-sm-i4c':    'Transport',
    'pl-sm-add':    'Add',
    ...
    // ── wallet.html ──
    'wa-h-eye':     'heva Wallet',
    'wa-h-h1':      'Your practice doesn\'t stop.<br>Neither should your money.',
    'wa-h-sub':     'The first digital bank for global medicine. Receive every payment instantly, hold your value in dollars, and withdraw whenever and however you want. No waits. No middlemen.',
